...
if __name__=="__main__":
  ...
  parser.add_argument('--left_file', default=f'{code_dir}/../zed/data/left.png', type=str)
  parser.add_argument('--right_file', default=f'{code_dir}/../zed/data/right.png', type=str)
